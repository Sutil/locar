package br.com.locar.config.webflow;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "br.com.locar.app", scopedProxy = ScopedProxyMode.TARGET_CLASS, useDefaultFilters = false, includeFilters = {
